...
async def test_parallel_vs_sequential():
    ...
    if sequential_time and parallel_time:
        ...
        if speedup > 1:
            ...
            print("⚠️  Parallel processing didn't show improvement (possibly due to overhead)")
    ...
    try:
        async with UnitOfWork() as uow:
            ...
            if simulations:
                ...
                retrieved_sim = await simulation_repo.get_by_simulation_id(latest_sim.simulation_id)
                
                if retrieved_sim:
                    print(f"✅ Successfully retrieved simulation: {retrieved_sim.simulation_id[:8]}...")
                ...
                print("ℹ️  No simulations found in database. Run some simulations first!")
