...
class DataFormatter:
    ...
    def _create_metadata(self, business_context: BusinessContext, simulation_id: str) -> Dict[str, Any]:
    ...
    def _format_interviews(self, interviews: List[SimulatedInterview]) -> List[Dict[str, Any]]:
    ...
    def _create_analysis_text(self, interviews: List[SimulatedInterview]) -> str:
        ...
        for interview in interviews:
            text_parts.append(f"=== Interview with {interview.stakeholder_type} ===")
    ...
    def _create_text_file(self, formatted_data: Dict[str, Any]) -> str:
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.txt', delete=False) as f:
            ...
            f.write(f"Business Idea: {formatted_data['metadata']['business_context']['business_idea']}\n")
            f.write(f"Target Customer: {formatted_data['metadata']['business_context']['target_customer']}\n")
            f.write(f"Problem: {formatted_data['metadata']['business_context']['problem']}\n\n")
            ...
            for persona in formatted_data['personas']:
                ...
                f.write(f"Motivations: {', '.join(persona['profile']['motivations'])}\n")
                f.write(f"Pain Points: {', '.join(persona['profile']['pain_points'])}\n\n")
