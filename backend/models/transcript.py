...
class TranscriptSegment(BaseModel):
    ...
    dialogue: str = Field(
        ...
        examples=["Good morning. Thanks for coming in. Can you start by telling me about your experience with project management tools?"]
    )
...
class TranscriptMetadata(BaseModel):
    ...
    date: Optional[str] = Field(
        None,
        description="Date of the interview/conversation"
    )

    duration: Optional[int] = Field(
        None,
        description="Duration of the interview/conversation in minutes"
    )
