...
def normalize_persona_to_dict(persona: Any) -> Dict[str, Any]:
    ...
    raise ValueError(f"Unknown persona type: {type(persona)}. Cannot convert to dictionary.")
    ...
    for i, persona in enumerate(personas):
        try:
            ...
            if 'confidence' not in normalized_persona:
                normalized_persona['confidence'] = safe_persona_access(persona, 'confidence', 0.5)
...
def extract_persona_field_safely(persona: Any, field: str, field_type: type = str) -> Any:
    """
...
def merge_persona_data(base_persona: Any, enhancement_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        try:
            ...
            return {'name': 'Unknown Persona', 'description': 'Merge failed', 'error': str(e)}
