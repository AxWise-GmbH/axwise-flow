      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            >
              <div className="inline-flex items-center gap-4 mb-10">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-400">Automated Design Thinking Engine</div>
                </div>
              </div>
            ...
            >
              Simulate complex human behavior at scale. From automatically analyzing passenger navigation in an airport via video streams to conducting thousands of simulated interviews, AxWise constructs reliable synthetic personas and deep datasets with verifiable ROI.
            </motion.p>
              ...
              <div className="bg-gradient-to-br from-black to-gray-900 text-white p-6">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm">Dataset Generation</div>
                    ...
                    {showPRD && (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-4">
                          <FileText className="w-5 h-5" />
                          <span className="text-sm">Dataset Generated</span>
                          <CheckCircle2 className="w-5 h-5 ml-auto" />
                        </div>
                        <div className="space-y-2.5 text-xs opacity-90">
                          {[
                            'Problem Definition',
                            'Simulated Interviews (50+)',
                            'Behavioral Analysis',
                            'Synthetic Personas (3)'
                          ].map((item, idx) => (
                            <motion.div
                              key={item}
