...
export const LogoHorizontal: React.FC<LogoProps> = ({ 
  ...
  return (
    ...
    >
      ...
      <text x="48" y="38" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" textAnchor="start" fill="#232946">Wise</text>

      {/* Tagline */}
      <text x="55" y="50" fontFamily="Arial, sans-serif" fontSize="10" fontWeight="normal" textAnchor="start" fill="#5d6387" textLength="170" lengthAdjust="spacingAndGlyphs">Your AI Co-Pilot for Product Development</text>
    </svg>
  );
};
